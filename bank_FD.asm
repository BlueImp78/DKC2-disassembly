...
hud_only_vram_payload:
	%vram_payload(number_and_banana_graphics, $1CC0, $0680, 0)
	db $00
...
monkey_museum_vram_payload:
	...
	%vram_payload(number_and_banana_graphics, $0200, $0280, 0)
	db $00
...
swankys_bonus_bonanza_vram_payload:
	...
	%vram_payload(text_tiledata, $6000, $2000, 0)
	%vram_payload(number_and_banana_graphics, $0200, $0280, 0)
	%vram_payload(number_and_banana_graphics, $1CC0, $0400, 0)
	db $00
...
stars_only_vram_payload:
	%vram_payload(bonus_star_graphics, $1E00, $0400, 0)
	db $00
...
;$FD88AD
debug_crosshair_graphics:
	incbin "data/gfx/sprite/static_vram_sprite_graphics/debug_crosshair_graphics.bin"

;$FD88CD
number_and_banana_graphics:
	incbin "data/gfx/sprite/static_vram_sprite_graphics/number_and_banana_graphics.bin"

;$FD8F4D
bonus_star_graphics:
	incbin "data/gfx/sprite/static_vram_sprite_graphics/bonus_star_graphics.bin"
